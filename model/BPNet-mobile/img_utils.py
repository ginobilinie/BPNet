...
def random_erasing(img, gt, gt_index=255, sl = 0.02, sh = 0.1, r1 = 0.3, mean=[123,116,103]):
    if random.random() >= 0.5:
        return img, gt,
    ...
    for attempt in range(100):
        ...
        if w < img.shape[1] and h < img.shape[0]:
            ...
            gt[x1:x1+h, y1:y1+w] = gt_index
            return img, gt,

    return img, gt,


def random_hsv(image, hue_shift_limit=(-180, 180),
    sat_shift_limit=(-255, 255), val_shift_limit=(-255, 255), u=0.5):
